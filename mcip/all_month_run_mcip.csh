...
source /hpcfs/home/ca.moreno12/CMAQ_v5.3.1/config_cmaq.csh intel

set APPL       = 201802"$1"
set CoordName  = LamConfCO   # 16-character maximum
set GridName   = 2018_NSthAm       # 16-character maximum

set DataPath   = /hpcfs/home/ca.moreno12/CMAQ_v5.3.1/cmaq_adj/data/Feb_2018
set InMetDir   = /hpcfs/home/ca.moreno12/CMAQ_v5.3.1/cmaq_adj/data/Feb_2018/mcip
set InGeoDir   = /hpcfs/home/ca.moreno12/CMAQ_v5.3.1/cmaq_adj/data/Feb_2018/mcip
set OutDir     = $DataPath/mcip/$GridName
set OutDir     = /hpcfs/home/ca.moreno12/mcip_feb
set ProgDir    = /hpcfs/home/ca.moreno12/CMAQ_v5.3.1/PREP/mcip/src
set WorkDir    = $OutDir
...
set InMetFiles = ( $InMetDir/wrfout_d01_201802 )

set IfGeo      = "T"
set InGeoFile  = $InGeoDir/geo_em_201802.d01.nc
...
set MCIP_START = 2018-02-"$1"_00:00:00.0000  # [UTC]
#set MCIP_START = 2018-02-28_00:00:00.0000

set MCIP_END   = 2018-02-"$2"_00:00:00.0000
#set MCIP_END = 2018-03-01_00:00:00.0000
